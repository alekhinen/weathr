...
Chart.defaults.global = {
    ...
    // Boolean - Whether the scale should stick to integers,
    //           not floats even if drawing space is there
    ...
    // Boolean - Determines whether to draw
    //           tooltips on the canvas or not
    showTooltips: true,
